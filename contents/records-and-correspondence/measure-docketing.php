            ...
            <?php if ($result->num_rows > 0): ?>
                <?php while($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($row["introducers"]); ?></td>
                        <td><?= htmlspecialchars($row["measure_type"]); ?></td>
                        <td><?= htmlspecialchars($row["measure_status"]); ?></td>
                        <td><?= htmlspecialchars($row["checking_remarks"]); ?></td>
                        <td><?= htmlspecialchars($row["checked_by"]); ?></td>
                        <td><?= date("m/d/Y h:i A", strtotime($row["datetime_submitted"])); ?></td>
                        <td>
                            <!-- Action Buttons -->
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 measure-details">
                                                    <h6 class="border-bottom pb-2 mb-3 sticky-top bg-white">Measure Information</h6>
                                                    <p><strong>Measure Code:</strong> <?= htmlspecialchars($row["m6_MD_Code"]) ?></p>
                                                    <p><strong>Title:</strong> <?= htmlspecialchars($row["measure_title"]) ?></p>
                                                    <p><strong>Content:</strong> <p style= "text-align: center;"><?= nl2br(htmlspecialchars($row["measure_content"], ENT_QUOTES, 'UTF-8')) ?></p></p>
                                                    <p><strong>Date Created:</strong> <?= date("m/d/Y", strtotime($row["date_created"])) ?></</p>
                                                    ...
                                                    <?php if ($row["docket_no"]): ?>
                                                        ...
                                                        <p><strong>Submitted:</strong> <?= date("m/d/Y h:i A", strtotime($row["datetime_submitted"])) ?>/p>
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form action="add_docket.php" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="doc_type_<?= $row['m6_MD_ID'] ?>" name="doc_type" value="<?= ucfirst($row["measure_type"]) ?>" readonly>
                                                            <!-- Hidden input to pass the real value -->
                                                            <input type="hidden" name="doc_type" value="<?= strtolower($row["measure_type"]) ?>">
                                                        ...
                                                        <div class="mb-3" id="subjectDiv_<?= $row['m6_MD_ID'] ?>" style="display: none;">
                                                            ...
                                                            <select class="form-select" id="subject_<?= $row['m6_MD_ID'] ?>" name="subjects">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="from_dept_<?= $row['m6_MD_ID'] ?>" value="<?= $row['checked_by'] ?>" readonly>
                                                            <input type="hidden" name="from_dept" value="<?= $row['checked_by'] ?>">
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        <button type="submit" class="btn btn-success">Accomplish</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
